        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <a
              ...
              className="inline-block bg-brand-yellow hover:bg-opacity-90 text-brand-dark px-8 py-4 rounded-lg text-lg font-semibold shadow-lg transform transition hover:scale-105"
              target="_blank"
                ...
                {category.calculators.map((calc, calcIdx) => (
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <calc.icon className="h-8 w-8 text-brand-primary" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <a
                href="https://go.juliangoldie.com/strategy-session"
                className="inline-block bg-brand-primary hover:bg-brand-dark text-white px-6 py-3 rounded-lg font-semibold transition-colors"
                target="_blank"
                rel="noopener noreferrer"
              >
